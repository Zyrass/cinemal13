...
<header>
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h1 class="text-center text-warning">Cinema L13 - Section Acteurs</h1>
                <h2 class="text-center">
                    <small>Voici la liste des acteurs enregistrés dans la BDD</small>
                </h2>
            </div> <!-- Fin col-xs-12 -->
        </div> <!-- Fin row -->
    </div> <!-- Fin container -->
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <?php foreach($actors as $value) : ?>
                                <tr class="text-center">
                                    ...
                                    <td width="20%" class="tdStyle"><?= $nomination($value['recompenses']); ?></td>
